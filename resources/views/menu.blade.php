...
<div id="home" class="w3-content">
    ...
    <div id="menu" class="w3-container w3-black w3-xxlarge w3-padding-64">
        ...
        <div class="w3-row w3-center w3-border w3-border-dark-grey">
            <a>
                <div id="PizzaTitle" class="w3-third w3-padding-large w3-red ">Pizza</div>
            </a>
            <a>
                <div id="PastaTitle" class="w3-third w3-padding-large w3-hover-red ">Pasta</div>
            </a>
            <a>
                <div id="StarterTitle" class="w3-third w3-padding-large w3-hover-red ">Starters</div>
            </a>
        </div>

        <div id="List" class="w3-container w3-white w3-padding-30">
        </div>
        <div id="FixedList">
            @foreach($pizza_menu as $menu)
                <div class="w3-container w3-white w3-padding-27">
                    <h1><b>{{$menu->name}}</b><span
                            class='w3-right w3-tag w3-dark-grey w3-round'>${{$menu->price}}</span></h1>
                    <hr>
                </div>
            @endforeach
        </div>
